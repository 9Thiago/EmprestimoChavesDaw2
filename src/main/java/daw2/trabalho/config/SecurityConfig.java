...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				// livre
				.antMatchers("/css/**", "/js/**","/index.html","/","/criarConta").permitAll()
				// admin
				.antMatchers("/gestaoUsuario/**","/novaChave/**").hasRole("ADMIN")
				//funcionario
				.antMatchers("/menuDeChaves/**").hasRole("USER")
				//admin ou funcionario
				.antMatchers("/emprestimos").hasAnyRole("ADMIN", "USER")
				.and()
